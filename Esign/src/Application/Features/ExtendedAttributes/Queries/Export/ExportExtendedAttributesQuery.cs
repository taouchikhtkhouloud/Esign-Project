...
using Esign.Application.Specifications.ExtendedAttribute;
using Esign.Domain.Contracts;
using Esign.Domain.Enums;
using Esign.Shared.Wrapper;
using MediatR;
using Microsoft.EntityFrameworkCore;
using Microsoft.Extensions.Localization;

namespace Esign.Application.Features.ExtendedAttributes.Queries.Export
{
