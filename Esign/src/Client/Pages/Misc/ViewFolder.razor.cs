...
//        // Rest of the code for the "file-list" page
...
//            var listParam = QueryHelpers.ParseQuery(queryString).TryGetValue("list", out var listValue) ? listValue.ToString() : null;

//            if (!string.IsNullOrEmpty(listParam))
//            {
//                _documentsList = JsonConvert.DeserializeObject<List<Document>>(Uri.UnescapeDataString(listParam));
//            }
...
//                state.Page = 0;
//            }
//            //int folderId = 123; // Replace with the appropriate folder ID

//            //// Call the API or perform any necessary logic to retrieve the files of the folder
//            //// Use the folderId to filter the files

//            //// Example code to retrieve the files using a mock service
//            //var files = await fileService.GetFilesByFolderId(folderId);

//            //// Return the files as TableData<GetFolderFilesResponse> object
//            //return new TableData<GetFolderFilesResponse>
//            //{
//            //    Items = files,
//            //    TotalItems = files.Count // Provide the total count of files
//            //};
//            await LoadData(state.Page, state.PageSize, state);
//            return new TableData<GetAllDocumentsResponse> { TotalItems = _totalItems, Items = _pagedData };
//        }

//        //private async Task<TableData<GetDocumentByFolderIdResponse>> ServerReload(TableState state)
//        //{
//        //    // Get the folder ID from the state or from another source
//        //    int folderId = Id; // Replace with the appropriate folder ID

//        //    // Call the API or perform any necessary logic to retrieve the files of the folder
//        //    // Use the folderId to filter the files

//        //    // Example code to retrieve the files using a mock service
//        //    var files = await DocumentTypeManager.GetFilesByFolderId(folderId);

//        //    // Return the files as TableData<GetFolderFilesResponse> object
//        //    return new TableData<GetDocumentByFolderIdResponse>
//        //    {
//        //        Items = _totalItems,
//        //        TotalItems = _pagedData // Provide the total count of files
//        //    };
//        //}
