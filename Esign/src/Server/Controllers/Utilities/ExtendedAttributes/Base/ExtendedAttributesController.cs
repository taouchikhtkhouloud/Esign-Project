...
using Esign.Application.Features.ExtendedAttributes.Commands.Delete;
...
using Esign.Application.Features.ExtendedAttributes.Queries.GetById;
using Esign.Domain.Contracts;
using Microsoft.AspNetCore.Mvc;

namespace Esign.Server.Controllers.Utilities.ExtendedAttributes.Base
{
    /// <summary>
